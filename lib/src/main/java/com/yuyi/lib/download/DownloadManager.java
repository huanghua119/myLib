...
public class DownloadManager {
     ...
     */
    public void download(String url, String path, DownLoadObserver downLoadObserver) {
        Observable.just(url)
                .filter(s -> !downCalls.containsKey(s))//call的map已经有了,就证明正在下载,则这次不下载
                .flatMap(s -> Observable.just(createDownInfo(s, path)))
     ...
     * @return DownInfo
     */
    private DownloadInfo createDownInfo(String url, String path) {
